package com.toparchy.molecule.bi.olap.repository.file;
...
import com.toparchy.molecule.bi.olap.config.Settings;
import com.toparchy.molecule.bi.olap.repository.AbstractFileSystemRepository;
import com.toparchy.molecule.bi.olap.repository.ReportContent;
import com.toparchy.molecule.bi.olap.repository.ReportFile;
import com.toparchy.molecule.bi.olap.repository.RepositoryFileComparator;
...
public class LocalFileSystemRepository extends AbstractFileSystemRepository {
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportRepository#getRoot()
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportRepository#exists(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportRepository#fileWithIdExists(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportRepository#getFile(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportRepository#getFileById(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportRepository#createDirectory(com.toparchy.molecule.bi.olap.repository.ReportFile,
	 *      java.lang.String)
	 */
	@Override
	...
	/**
	 * @throws IOException
	 * @see com.toparchy.molecule.bi.olap.repository.ReportRepository#createFile(com.toparchy.molecule.bi.olap.repository.ReportFile,
	 *      java.lang.String,
	 *      com.toparchy.molecule.bi.olap.repository.ReportContent)
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportRepository#readContent(com.toparchy.molecule.bi.olap.repository.ReportFile)
	 */
	@Override
	 ...
	 * @see com.toparchy.molecule.bi.olap.repository.ReportRepository#setReportContent(com.toparchy.molecule.bi.olap.repository.ReportFile,
	 *      com.toparchy.molecule.bi.olap.repository.ReportContent)
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportRepository#renameFile(com.toparchy.molecule.bi.olap.repository.ReportFile,
	 *      java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportRepository#deleteFile(com.toparchy.molecule.bi.olap.repository.ReportFile)
	 */
	@Override
