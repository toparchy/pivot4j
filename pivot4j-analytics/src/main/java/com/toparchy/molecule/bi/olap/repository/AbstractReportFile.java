...
public abstract class AbstractReportFile implements ReportFile {
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportFile#getId()
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportFile#getAncestors()
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportFile#isRoot()
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.repository.ReportFile#getExtension()
	 */
	@Override
