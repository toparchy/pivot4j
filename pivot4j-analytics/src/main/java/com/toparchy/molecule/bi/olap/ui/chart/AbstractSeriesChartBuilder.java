...
public abstract class AbstractSeriesChartBuilder<C extends CartesianChart>
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.ui.chart.AbstractChartBuilder#startSeries(org.pivot4j.ui.chart.ChartRenderContext)
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.ui.chart.AbstractChartBuilder#endSeries(org.pivot4j.ui.chart.ChartRenderContext)
	 */
	@Override
