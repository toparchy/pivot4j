...
public class ViewHandler implements QueryListener, ModelChangeListener {
	...
	public LayoutOptions getLayoutOptions() {
		if (layoutOptions == null) {
			...
			toolbarOptions.addOption("spacing_open", 0);
			toolbarOptions.addOption("spacing_closed", 0);
			...
			cubeListOptions.addOption("spacing_open", 0);
			cubeListOptions.addOption("spacing_closed", 0);
