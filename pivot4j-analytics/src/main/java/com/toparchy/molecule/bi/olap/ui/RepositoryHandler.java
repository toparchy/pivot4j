package com.toparchy.molecule.bi.olap.ui;
...
import com.toparchy.molecule.bi.olap.component.tree.DefaultTreeNode;
import com.toparchy.molecule.bi.olap.config.Settings;
import com.toparchy.molecule.bi.olap.datasource.DataSourceManager;
import com.toparchy.molecule.bi.olap.repository.DataSourceNotFoundException;
import com.toparchy.molecule.bi.olap.repository.ReportContent;
import com.toparchy.molecule.bi.olap.repository.ReportFile;
import com.toparchy.molecule.bi.olap.repository.ReportRepository;
import com.toparchy.molecule.bi.olap.repository.RepositoryFileComparator;
import com.toparchy.molecule.bi.olap.repository.RepositoryFileFilter;
import com.toparchy.molecule.bi.olap.state.ViewState;
import com.toparchy.molecule.bi.olap.state.ViewStateEvent;
import com.toparchy.molecule.bi.olap.state.ViewStateHolder;
import com.toparchy.molecule.bi.olap.state.ViewStateListener;
import com.toparchy.molecule.bi.olap.ui.navigator.RepositoryNode;
...
public class RepositoryHandler implements ViewStateListener, Serializable {
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.state.ViewStateListener#viewRegistered(com.toparchy.molecule.bi.olap.state.ViewStateEvent)
	 */
	@Override
	...
	/**
	 * @see com.toparchy.molecule.bi.olap.state.ViewStateListener#viewUnregistered(com.toparchy.molecule.bi.olap.state.ViewStateEvent)
	 */
	@Override
	...
	static class DefaultExtensionFilter implements RepositoryFileFilter {
		...
		/**
		 * @see com.toparchy.molecule.bi.olap.repository.RepositoryFileFilter#accept(com.toparchy.molecule.bi.olap.repository.ReportFile)
		 */
		@Override
