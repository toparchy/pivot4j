...
public class DrillExpandPositionImpl extends AbstractTransform implements
	...
	/**
	 * @see org.pivot4j.transform.DrillExpandPosition#canExpand(org.olap4j.Position,
	...
	/**
	 * @see org.pivot4j.transform.DrillExpandPosition#canCollapse(org.olap4j.Position,
	 *      org.olap4j.metadata.Member)
	 * @param position
	 *            position to be expanded
	 * @return true if the member can be expanded
	...
	/**
	 * @see org.pivot4j.transform.DrillExpandPosition#expand(org.olap4j.Position,
	 *      org.olap4j.metadata.Member)
	 * @param position
	 *            position to be expanded
	 * @param member
	...
	/**
	 * @see org.pivot4j.transform.DrillExpandPosition#collapse(org.olap4j.Position,
	 *      org.olap4j.metadata.Member)
	 * @param position
